...
export default function Home() {
  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="absolute top-[-250px] left-[-200px] w-[600px] h-[600px] rounded-full bg-primary/5 blur-[120px] -z-10" />
      <div className="absolute bottom-[-250px] right-[-200px] w-[600px] h-[600px] rounded-full bg-secondary/5 blur-[120px] -z-10" />
